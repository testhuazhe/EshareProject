            ...
            <div class="lock-container">
                ...
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                    	...
                    	Enter Temporary Code: <input class="form-control" type="text" name="code" placeholder="Enter the code received via Email">
                        <button class="btn btn-primary" type="submit">Verify <i class="fa fa-fw fa-unlock-alt"></i></button><br><br>
                         Didn't receive the code?<a href="forgotpassword.jsp" class="forgot-password">Resend Code</a> 
                        </form>
                    </div>
                </div>
            </div>
