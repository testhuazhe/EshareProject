		...
		<div class="list-sections animated-middle">
			...
			<ul>
				...
				<li class="item-list"> <!-- 1 / .who part -->
					...
					<a href="hi.jsp" class="open-popup-link">
				
						<div class="item-title">
							<h2><span class="point" style="color:#bdb4ac;">Main</span> <strong>Preview</strong></h2>
							<p><img src="img/1logo.png"></p>
						</div> <!-- .item-title -->

						<div class="item-plus"><p>Suitable for personal timelines / blogs sites<br>(doesn't show all available features)</p><br>
				...
				<li class="item-list"> <!-- 2 / .when part -->
					...
					<a href="hi.jsp" class="open-popup-link">
						...
						<div class="item-title">
                            <h2><span class="point" style="color:#72c14c;">Bakery </span><strong>Preview</strong></h2>
							<p><img src="img/2logo.png"></p>
						</div> <!-- .item-title -->

						<div class="item-plus"><p>Suitable for any food related timelines / blogs <br>(doesn't show all available features)</p><br><svg version="1.1" id="Layer_1" width="60px" height="60px" viewBox="0 0 300 300" style="enable-background:new 0 0 300 300;" xml:space="preserve">
